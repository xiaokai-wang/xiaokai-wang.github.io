...
<img src="https://github.com/weibocom/nginx-upsync-module/raw/master/doc/images/consul-template-reload-qps.png" alt="consul-template-reload-qps" height="60%" width="60%">
```
图示：reload时nginx的请求处理能力会下降（注：nginx对于握手成功的请求不会丢失）
```
<img src="https://github.com/weibocom/nginx-upsync-module/raw/master/doc/images/consul-template-reload-cost.png" alt="consul-template-reload-cost" height="60%" width="60%">
```
...
<img src="https://github.com/weibocom/nginx-upsync-module/raw/master/doc/images/upsync-vs-reload-qps.png" alt="upsync-vs-reload-qps" height="60%" width="60%">
...
<img src="https://github.com/weibocom/nginx-upsync-module/raw/master/doc/images/upsync-vs-reload-cost.png" alt="upsync-vs-reload-cost" height="60%" width="60%">
